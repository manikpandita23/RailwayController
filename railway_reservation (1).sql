...
(6, 51, 'Sundarbans Express', 'Express', 'Dhaka', 'Khulna', 600, 601),
(7, 52, 'Brahmaputra Local', 'Local', 'Rangpur', 'Dhaka', 700, 600),
(8, 53, 'Teesta Mail', 'Mail', 'Sylhet', 'Rajshahi', 603, 702),
(9, 54, 'Meghna Commuter', 'Commuter', 'Chittagong', 'Dhaka', 501, 600),
(10, 55, 'Jamuna Shuttle', 'Shuttle', 'Dhaka', 'Rajshahi', 600, 702);
-- --------------------------------------------------------
...
(5, 45, '2016-04-01', 2, 2);
(6, 46, '2016-04-02', 10, 0),
(7, 47, '2016-04-03', 15, 5),
(8, 48, '2016-04-04', 20, 0),
(9, 49, '2016-04-05', 5, 15),
(10, 50, '2016-04-06', 0, 20);
-- --------------------------------------------------------
